...
public:
    ...
    /* 0x10B4 */ Z2Creature mCreature;
    /* 0x1144 */ fpc_ProcID mRodId;
    /* 0x1145 */ u8 field_0x1144[0x114A - 0x1148];
    ...
    /* 0x1190 */ dBgS_AcchCir mAcchCir;
    /* 0x11D0 */ dBgS_ObjAcch mObjAcch;
    ...
    /* 0x168E */ u8 field_0x168e;
    /* 0x168F */ u8 field_0x168f;
};
